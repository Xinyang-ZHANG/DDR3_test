...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_decoder is
  port (
    ...
    \G_PROBE_OUT[1].wr_probe_out[1]_i_3_0\ : out STD_LOGIC;
    \G_PROBE_OUT[1].wr_probe_out[1]_i_4_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_decoder is
  ...
  signal \^g_probe_out[1].wr_probe_out[1]_i_3_0\ : STD_LOGIC;
  signal \^g_probe_out[1].wr_probe_out[1]_i_4_0\ : STD_LOGIC;
...
begin
  \G_PROBE_OUT[1].wr_probe_out[1]_i_3_0\ <= \^g_probe_out[1].wr_probe_out[1]_i_3_0\;
  \G_PROBE_OUT[1].wr_probe_out[1]_i_4_0\ <= \^g_probe_out[1].wr_probe_out[1]_i_4_0\;
  SR(0) <= \^sr\(0);
  in0 <= \^in0\;
...
\G_PROBE_OUT[1].wr_probe_out[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => s_daddr_o(11),
      I3 => s_daddr_o(10),
      O => \^g_probe_out[1].wr_probe_out[1]_i_4_0\
    );
\G_PROBE_OUT[1].wr_probe_out[1]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\rd_en[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
        ...
        port map (
      I0 => \rd_en[6]_i_2_n_0\,
      I1 => \^g_probe_out[1].wr_probe_out[1]_i_3_0\,
      I2 => \^g_probe_out[1].wr_probe_out[1]_i_4_0\,
      I3 => \^s_den_o_inst_0\,
      O => \rd_en[6]_i_1_n_0\
    );
...
\wr_en[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => s_dwe_o,
      I2 => \^s_den_o_inst_0\,
      I3 => \^g_probe_out[1].wr_probe_out[1]_i_4_0\,
      I4 => \^g_probe_out[1].wr_probe_out[1]_i_3_0\,
      O => \wr_en[2]_i_1_n_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_probe_out_all is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \G_PROBE_OUT[0].wr_probe_out[0]_i_1\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \G_PROBE_OUT[3].wr_probe_out[3]_i_2\ : label is "soft_lutpair22";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_vio is
  ...
  signal probe_width_int : STD_LOGIC_VECTOR ( 9 downto 8 );
...
DECODER_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_decoder
     port map (
      \Bus_data_out_reg[9]_0\(1 downto 0) => probe_width_int(9 downto 8),
      \G_PROBE_OUT[1].wr_probe_out[1]_i_3_0\ => DECODER_INST_n_5,
      \G_PROBE_OUT[1].wr_probe_out[1]_i_4_0\ => DECODER_INST_n_6,
      Q(2) => PROBE_OUT_ALL_INST_n_13,
      Q(1) => PROBE_OUT_ALL_INST_n_14,
      Q(0) => PROBE_OUT_ALL_INST_n_15,
      SR(0) => clear,
      in0 => committ,
      internal_cnt_rst => internal_cnt_rst,
      \out\ => bus_clk,
...
PROBE_OUT_ALL_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_probe_out_all
     port map (
      ...
      \G_PROBE_OUT[1].wr_probe_out_reg[1]_1\ => DECODER_INST_n_6,
      \G_PROBE_OUT[1].wr_probe_out_reg[1]_2\ => DECODER_INST_n_7,
...
PROBE_OUT_WIDTH_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_probe_width
     port map (
      CLK => bus_clk,
      Q(1 downto 0) => probe_width_int(9 downto 8),
      internal_cnt_rst => internal_cnt_rst,
      rd_probe_out_width => rd_probe_out_width,
      s_rst_o => bus_rst
    );
