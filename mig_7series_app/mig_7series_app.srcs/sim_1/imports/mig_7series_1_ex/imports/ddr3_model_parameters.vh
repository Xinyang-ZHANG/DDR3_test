...
`define sg                                // sg15E is equivelant to the JEDEC DDR3-1333H (9-9-9) speed bin
    ...
    parameter TCKE             =    6000; // tCKE       ps    CKE minimum high or low pulse width
...
`define custom_part_width
    parameter TRRD             =    11250; // tRRD       ps     Active bank a to Active bank b command time
    parameter TFAW             =   27000; // tFAW       ps     Four Bank Activate window
    ...
    // Refresh - 1Gb
    parameter TRFC_MIN         =  260625; // tRFC       ps    Refresh to Refresh Command interval minimum value
...
`define custom_part_width
    ...
    parameter MEM_BITS         =      26; // Set this parameter to control how many write data bursts can be stored in memory.  The default is 2^10=1024.
