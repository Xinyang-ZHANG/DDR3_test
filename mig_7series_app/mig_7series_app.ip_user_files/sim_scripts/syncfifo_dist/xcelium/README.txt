...
#
# Generated by export_simulation on Tue Aug 06 23:51:28 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './syncfifo_dist.sh' script.

./syncfifo_dist.sh -reset_run
...
./syncfifo_dist.sh -noclean_files

For more information on the script, please type './syncfifo_dist.sh -help'.
