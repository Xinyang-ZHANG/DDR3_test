...
#
# Generated by export_simulation on Sun Jul 21 12:51:00 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_50_200.sh' script.

./clk_wiz_50_200.sh -reset_run
...
./clk_wiz_50_200.sh -noclean_files

For more information on the script, please type './clk_wiz_50_200.sh -help'.
